...
ggplot()+
    ...
    geom_line(data= outputDF.100, aes(x= scaleYear+1996, y= scaledGasolineConsumptionWithEVs*20*4.53e-13, color = "100%"), size = 2, alpha = .7)+
    scale_colour_manual("", breaks = c("BAU", "10%", "50%", "100%"),values = c("BAU"="grey1", "10%"="grey2", "50%" = "grey3", "100%"= "red"))+
    ylim(0,1.6)+ylab("CO2 Emissions, GTons")+xlab("Year")+xlim(1996,2100)+
    theme(text = element_text(size = 24))#+ggtitle("EVs replacing Car and Car SUV Sales")
...
ggplot()+
    geom_line(data=CashForClunkers2[[1]], aes(x=scaleYear+1996, y =scaledGasolineConsumptionWithEVs*20*4.53e-13, color=".5 * BAU"), size=2, alpha= .7)+
    geom_line(data=CashForClunkers2[[2]], aes(x=scaleYear+1996, y =scaledGasolineConsumptionWithEVs*20*4.53e-13, color="1 * BAU"), size=2, alpha= .7)+
    geom_line(data=CashForClunkers2[[3]], aes(x=scaleYear+1996, y =scaledGasolineConsumptionWithEVs*20*4.53e-13, color="1.25 * BAU"), size=2, alpha= .7)+
    geom_line(data=CashForClunkers2[[4]], aes(x=scaleYear+1996, y =scaledGasolineConsumptionWithEVs*20*4.53e-13, color="1.5 * BAU"), size=2, alpha= .7)+
    geom_line(data=CashForClunkers2[[5]], aes(x=scaleYear+1996, y =scaledGasolineConsumptionWithEVs*20*4.53e-13, color="2 * BAU"), size=2, alpha= .7)+
    ylab("CO2 Emissions (GTons)")+xlab("Year")+theme(text=element_text(size=24))+ylim(0,1.6)+
    ggtitle("Cash For (all) Clunkers: Worth it to increase buying rates?")
...
#    geom_line(data= retroDF.05, aes(x= scaleYear+1996, y= scaledGasolineConsumptionWithEVs*20, color = "05%"), size = 2, alpha = .7)+
    geom_line(data= retroDF.10, aes(x= scaleYear+1996, y= scaledGasolineConsumptionWithEVs*20, color = "010%"), size = 2, alpha = .7)+
#    geom_line(data= retroDF.25, aes(x= scaleYear+1996, y= scaledGasolineConsumptionWithEVs*20, color = "25%"), size = 2, alpha = .7)+
    geom_line(data= retroDF.50, aes(x= scaleYear+1996, y= scaledGasolineConsumptionWithEVs*20, color = "050%"), size = 2, alpha = .7)+
#    geom_line(data= retroDF.75, aes(x= scaleYear+1996, y= scaledGasolineConsumptionWithEVs*20, color = "75%"), size = 2, alpha = .7)+
    ...
    ylim(0,3.6e+12)+ylab("CO2 Emissions, scaled to ``On-the-road'' efficiency")+xlab("Year")+ggtitle("Retrofitting of Cars, Car SUVs, and Trucks after 2018; percents shown are retrofits per year")+
    theme(text = element_text(size = 14))
...
ggplot() +
    geom_line(data= totalVMT, aes(
        x=X...Year., y= Million.Miles, color = "actuals"), size = 2) +
...
# Graphing for different vehicle classes 

ggplot()+ 
    # geom_line(data = outputDF.50.fast, 
    #     aes(x = scaleYear, y= efficiencyWithEVs, color = "fast"))+
    # geom_line(data = outputDF.50.medium, 
    #     aes(x = scaleYear, y= efficiencyWithEVs, color = "medium"))+
    # geom_line(data = outputDF.50.slow, 
    #     aes(x = scaleYear, y= efficiencyWithEVs, color = "slow"))+
    # geom_line(data = outputDF.50.vslow, 
    #     aes(x = scaleYear, y= propEVS, color = "All EVs, staggered"),
    #     size = 2, alpha = .7)+
    geom_line(data = outputDF.50.noVan, 
        aes(x = scaleYear, y= propEVS, color = "No Van EVs"),
        size = 2, alpha = .7)+
    geom_line(data = outputDF.50.noVanOrPickup, 
        aes(x = scaleYear, y= propEVS, color = "No Van or Pickup EVs"),
        size = 2, alpha = .7)+
    geom_line(data = outputDF.50.noTruck, 
        aes(x = scaleYear, y= propEVS, color = "No Truck EVs"),
        size = 2, alpha = .7)+
    geom_line(data = outputDF.50.noCar, 
        aes(x = scaleYear, y= propEVS, color = "No Car EVs"),
        size = 2, alpha = .7)+
    geom_line(data = outputDF.50.noCarSUV, 
        aes(x = scaleYear, y= propEVS, color = "No Car SUV EVs"),
        size = 2, alpha = .7)
